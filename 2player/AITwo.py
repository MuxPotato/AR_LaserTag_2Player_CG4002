...
class AITwo(Thread):
    ...
    def run(self):
        ...
        while True:  
            ...
            try:
                message_ankle = self.P2_ankle_queue.get(timeout = 0.005)
                print("AITwo: Received item from ankle queue")
            ...
            try:
                message_IMU = self.P2_IMU_queue.get(timeout=0.005)
                
                print("AITwo: Received item from IMU queue")
                #self.last_activity_time = time.time()
            ...
            print("AITwo: current IMU message count: ", len(messages_IMU))
            ...
            if len(messages_IMU) == PACKET_NUMBER:
                print("AITwo: Sending data for prediction")
                data = {
