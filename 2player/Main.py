...
game_engine = GameEngine(P1_action_queue=P1_action_queue,P2_action_queue=P2_action_queue,viz_queue=viz_queue, eval_queue=eval_queue, from_eval_queue = from_eval_queue, phone1_response_queue=phone1_response_queue,phone2_response_queue=phone2_response_queue,shot_queue = shot_queue,to_rs_queue = to_rs_queue)
