...
p1_ai = AIOne(P1_IMU_queue=P1_IMU_queue,P1_action_queue=P1_action_queue, P1_fire_queue = P1_fire_queue,P1_ankle_queue = P1_ankle_queue)
p2_ai = AITwo(P2_IMU_queue=P2_IMU_queue,P2_action_queue=P2_action_queue, P2_fire_queue = P2_fire_queue,P2_ankle_queue = P2_ankle_queue)
