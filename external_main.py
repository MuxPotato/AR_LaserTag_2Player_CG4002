...
if __name__=="__main__":
    ...
    int_main = InternalMainThread(outgoing_p1_ankle_queue,outgoing_p1_glove_queue,outgoing_p2_ankle_queue,outgoing_p2_glove_queue,outgoing_game_state_queue,incoming_game_state_queue)
...
#    output_dir = "output/"
    ...
    relay_client = RelayClient(SERVER_IP, SERVER_PORT, outgoing_p1_ankle_queue,outgoing_p1_glove_queue,outgoing_p2_ankle_queue,outgoing_p2_glove_queue, outgoing_game_state_queue, incoming_game_state_queue)
    # TODO: Remove 2 lines below
...
#            f"""{output_dir}/{glove_output_filename}""", f"""{output_dir}/{game_state_output_filename}""")
    try:
        ...
        relay_client.quit()
        time.sleep(1)
        print(f"""Number of elements in outgoing player 1 glove queue: {outgoing_p1_glove_queue.qsize()}""")
